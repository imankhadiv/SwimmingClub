...
RSpec.describe "swimming_records/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit swimming_record form" do
    render

    assert_select "form[action=?][method=?]", swimming_record_path(@swimming_record), "post" do
